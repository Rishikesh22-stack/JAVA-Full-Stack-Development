...
<body>
	...
	<center>
		...
		<div
			style="border: 3px solid black; width: 25%; border-radius: 10px; padding: 20px"
			align="center">
			<form action=InsertFlight method=post>
				<label for=name>Name :-</label> <input type="text" name=name id=name /><br>
				<br> <label for=Source>Source :-</label> <input type="text"
					name=Source id=Source /><br> <br> <label for=Dest>Dest
					:-</label> <input type="text" name=Dest id=Dest /><br> <br> <label
